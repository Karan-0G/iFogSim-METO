...
public abstract class ModulePlacement {
	...
	public ModulePlacement() {
        this.moduleToDeviceMap = new HashMap<>(); // Initialize this map
        this.deviceToModuleMap = new HashMap<>(); // Initialize this map (THE KEY FIX!)
        this.moduleInstanceCountMap = new HashMap<>(); // Initialize this map
        this.modulesOnPath = new HashMap<>(); // Also good to initialize these protected ones
        this.modulesOnDevice = new HashMap<>(); // Also good to initialize these protected ones
        this.clusteringFeature = false; // Default value
    }
